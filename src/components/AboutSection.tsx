    ...
    <section id="about" className="py-16 bg-gradient-to-b from-background to-muted/50">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12 animate-slideInLeft">
          ...
          <div className="max-w-lg mx-auto p-8  from-primary/10 to-accent/10 rounded-xl mb-12">
          ...
          <div className="animate-fadeUp">
            <div className="grid gap-5">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <Card className="p-5 border-0 bg-gradient-to-br from-accent/5 to-primary/5">
